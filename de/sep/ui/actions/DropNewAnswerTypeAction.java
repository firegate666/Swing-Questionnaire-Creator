...
/**
 * A <code>NewAnswerTypeAction<code> is invoked if the user wants to insert a new
 * answer type into a question.
 */
public class DropNewAnswerTypeAction extends AbstractQuestionaireAction {
	 ...
	 */
	public DropNewAnswerTypeAction(String name, Questionaire app) {
		super(name, app);
	}
	...
	public void actionPerformed(ActionEvent evt) {
		...
		QuestionPanel source = ((AnswerTypesPanel) evt.getSource()).getQuestionPanel();
		
		((Questionaire) getApp()).getFactory().insertAnswerType(
			AnswerType.lookup(Integer.parseInt(evt.getActionCommand())),
			source.getQuestion(), evt.getModifiers());
	}
}